...
var Device = function(id,protocol,language,options,ini,logger) {
    ...
    return {
        ...
        initstate: function(socket,db,collection) {
            if (typeof(trans.setId)=='function') trans.setId(id);
            if (typeof(com.initstate)=='function') com.initstate(socket,db,collection);
            if (typeof(trans.initstate)=='function') trans.initstate(db,collection);
